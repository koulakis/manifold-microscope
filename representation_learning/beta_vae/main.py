"""
Command-line entry point for the adapted beta-VAE implementation.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_epochs', default=500, type=int, help='maximum number of epochs')
    parser.add_argument('--number_of_dims', default=4, type=int, help='number of dimensions to keep in the dataset')
    parser.add_argument('--training_ratio_per_dim', default=1.0, type=float, help='ratio of training data adjusted per dim')
    parser.add_argument('--noise_sigma', default=0.0, type=float, help='Gaussian noise to add to the data')
